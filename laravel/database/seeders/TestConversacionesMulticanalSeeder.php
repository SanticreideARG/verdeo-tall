        ...
        return [
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->ver('¡Hola Lucas! Claro. El Pack Keto es sin harinas ni cereales, con proteínas magras, vegetales y grasas buenas. ¿Preferís 250g o 400g?', 46),
                    $this->cli('¿Cuál es la diferencia práctica entre los dos?', 44),
                    $this->ver('El 250g alcanza para el almuerzo de una persona. El 400g cubre almuerzo y cena. Ambos de lunes a viernes', 42),
                    $this->cli('¿Y cuánto sale cada uno?', 40),
                    $this->ver('Keto 250g → $65.000/sem · 400g → $80.000/sem. Entrega los miércoles en CABA y GBA', 38),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('El Real entonces. ¿El 250g alcanza para dos personas al mediodía?', 122),
                    $this->ver('Para dos personas recomendamos 2 packs de 250g o 1 pack de 400g por persona si comen bastante. ¿Cómo prefieren manejarlo?', 120),
                    $this->cli('Dos de 250g estaría bien. ¿Cuánto sería el total?', 60),
                    $this->ver('2 packs Real 250g → $140.000/sem (2 × $70.000) con entrega incluida en CABA. ¿En qué barrio están?', 30),
                ],
            ],
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('Suena muy bien! ¿El precio del 400g?', 170),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('El keto 400g. Muchas gracias!', 1434),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('No, solo eso. ¿El precio del 250g?', 83),
                    $this->ver('Anti-Age 250g → $65.000/sem con entrega en Cipolletti los miércoles. Anotamos la aclaración sin mariscos', 80),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('Perfecto. ¿Cuál es el precio del 400g?', 362),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('Yo el anti-age 250g y ella el real 250g, tiene problemas de presión', 506),
                    ...
                    $this->ver('Anti-Age 250g ($65.000) + Real 250g ($70.000) = $135.000 con entrega incluida', 496),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('Sí, bueno. ¿El Pack Intuitivo qué tan abundante es el 400g?', 712),
                    $this->ver('El 400g cubre almuerzo y cena de una persona holgadamente. ¿Tenés alguna restricción alimentaria?', 710),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('Entiendo. Me quedo con el Intuitivo 250g. ¿A qué hora llega el miércoles?', 2882),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('Perfecto, es lo que busco. ¿El 400g para almuerzo y cena?', 173),
                    $this->ver('¡Exacto! El 400g cubre almuerzo y cena de una persona. ¿Querés ver el menú de esta semana?', 171),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->ver('Solo almuerzo y cena de lunes a viernes. El 400g es bastante abundante si lo dividís bien', 984),
                    $this->cli('¿El precio del 250g?', 982),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('¿Cuánto sale el Intuitivo 250g?', 310),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->ver('Para ese nivel de actividad, el 400g del Pack Real o Keto sería lo mínimo. Muchos deportistas de ese nivel complementan con una fuente extra de proteína en la cena', 54),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->ver('El Pack Keto es el más adecuado entonces. Prácticamente sin carbohidratos. ¿El 250g o el 400g?', 540),
                    $this->cli('¿Cuánto sale el 250g?', 410),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('¿Cuánto sale el 250g?', 63),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('¿Qué tan llenador es el 250g para el almuerzo?', 321),
                    $this->ver('Bastante llenador. Calculado para un almuerzo completo. Si comés mucho o sos activo, el 400g da más margen', 319),
                    $this->cli('¿Puedo empezar con el 250g y pasarme al 400g si necesito más?', 317),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('¿Cuánto sale el 250g?', 133),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('¿Cuánto sale el 250g anti-age?', 88),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli('¿Cuánto sale el intuitivo 400g?', 185),
