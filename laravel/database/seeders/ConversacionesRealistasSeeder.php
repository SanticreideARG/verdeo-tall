...
class ConversacionesRealistasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($precios as $tipo => [$p250, $p400]) {
            Producto::where('tipo', $tipo)->update(['precio_250kcal' => $p250, 'precio_400kcal' => $p400]);
        }
    ...
    private function crearOrden(User $user, string $zona, array $od): void
    {
        ...
        foreach ($od['items'] as $it) {
            ...
            $precio   = $it['tamano'] === '400kcal' ? $producto->precio_400kcal : $producto->precio_250kcal;
        ...
        return [
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->ver(9, '10:19', 'El Pack Keto es un menú semanal sin harinas ni cereales: proteínas magras, vegetales y grasas buenas. 250 Kcal ($65.000/sem) o 400 Kcal ($80.000/sem) con entrega los miércoles'),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->ver(7, '09:37', 'El 250 Kcal a $65.000 y el 400 Kcal a $80.000 semanales, con entrega incluida en Mendoza capital'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'items'  => [['tipo' => 'keto', 'tamano' => '400kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    $this->cli(3, '10:15', 'Hola! Quisiera hacer un pedido del pack keto'),
                    $this->ver(3, '10:16', '¡Hola Juan! Con gusto. ¿El pack de 250 Kcal o 400 Kcal?'),
                    $this->cli(3, '10:17', '400 Kcal para mí solo, suelo comer bastante jaja'),
                    $this->ver(3, '10:18', 'Perfecto, el 400 Kcal es ideal. Son $80.000 semanales. ¿En qué barrio de CABA estás?'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [['tipo' => 'real', 'tamano' => '400kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    ...
                    $this->cli(2, '17:34', '400 Kcal. ¿Cuánto sale?'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [['tipo' => 'vegetariano', 'tamano' => '250kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    ...
                    $this->cli(4, '14:09', 'Todo se ve muy bien! Me anoto con el de 250 Kcal'),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli(1, '09:03', 'Para mí solo. El 400 Kcal'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [['tipo' => 'anti_age', 'tamano' => '400kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    ...
                    $this->cli(5, '11:26', '¿El 400 Kcal alcanza para almuerzo y cena?'),
                    $this->ver(5, '11:27', 'Sí! El 400 Kcal está calculado para almuerzo y cena de una persona'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [
                        ['tipo' => 'real', 'tamano' => '400kcal', 'cantidad' => 1],
                        ['tipo' => 'real', 'tamano' => '400kcal', 'cantidad' => 1],
                    ],
                ]],
                'mensajes' => [
                    ...
                    $this->ver(6, '19:34', 'Sí, cubrimos Palermo. 2 packs 400 Kcal son $170.000 la semana con entrega incluida'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [['tipo' => 'keto', 'tamano' => '250kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    ...
                    $this->cli(3, '15:48', 'Eso es lo que necesito jaja. ¿El 250 Kcal alcanza para el mediodía?'),
                    $this->ver(3, '15:49', 'Sí, el 250 Kcal es perfecto para una persona al almuerzo. Si querés también cena, el 400 Kcal cubre ambas'),
                    $this->cli(3, '15:50', 'Arranco con el 250 Kcal a probar. ¿Cuánto?'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [['tipo' => 'vegetariano', 'tamano' => '400kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    ...
                    $this->cli(2, '08:33', 'Vegetariano 400 Kcal, para el almuerzo y la cena'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [['tipo' => 'real', 'tamano' => '250kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    $this->cli(7, '13:00', 'Hola! Vi que tienen el Pack Real sin ultraprocesados. ¿El 250 Kcal está bien para una persona al mediodía?'),
                    $this->ver(7, '13:02', '¡Hola Cami! Sí, el 250 Kcal es ideal para el almuerzo. Si querés cubrirte también la cena, el 400 Kcal da para ambas'),
                    $this->cli(7, '13:03', 'Arranco a probar con el 250 Kcal. ¿Cuánto?'),
            ...
            [
                ...
                'mensajes' => [
                    $this->cli(4, '17:00', 'Hola! Consulta: el pack keto 400 Kcal, ¿qué incluye exactamente?'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [['tipo' => 'anti_age', 'tamano' => '250kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    $this->cli(23, '11:30', 'Hola! Quisiera probar el pack anti-age. ¿Cómo funciona?'),
                    $this->ver(23, '11:32', '¡Hola Pilar! Son menús semanales con ingredientes antiinflamatorios y antioxidantes, frescos y sin conservantes. ¿Preferís 250 Kcal o 400 Kcal?'),
                    $this->cli(23, '11:33', '250 Kcal para probar primero'),
                    ...
                    $this->cli(21, '11:47', 'Sí! El salmón con cúrcuma sorprendió mucho. La semana que viene pido el 400 Kcal'),
            ...
            [
                ...
                'ordenes' => [[
                    ...
                    'forma_pago' => 'transferencia',
                    'items'  => [['tipo' => 'intuitivo', 'tamano' => '400kcal', 'cantidad' => 1]],
                ]],
                'mensajes' => [
                    ...
                    $this->cli(30, '16:05', 'No, estoy bien. Me anoto con el 400 Kcal'),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->ver(37, '13:04', '¡Genial! Nuestro Pack Vegetariano es muy variado, te va a encantar. ¿250 Kcal o 400 Kcal?'),
                    $this->cli(37, '13:05', '250 Kcal para empezar'),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli(44, '10:05', 'Perfecto, lo que necesitaba. Me anoto con el 400 Kcal'),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->ver(47, '09:19', '250 Kcal ($65.000) o 400 Kcal ($80.000) semanal, con entrega en Neuquén los miércoles'),
                    $this->cli(47, '09:20', 'El 400 Kcal. Empiezo esta semana'),
            ...
            [
                ...
                'ordenes' => [
                    ...
                    [
                        ...
                        'forma_pago' => 'transferencia',
                        'items'  => [['tipo' => 'vegetariano', 'tamano' => '400kcal', 'cantidad' => 1]],
                        'notas'  => 'Subió a 400 Kcal desde el segundo pedido',
                    ],
                ],
                'mensajes' => [
                    ...
                    $this->cli(52, '14:03', 'Perfecto! Empiezo con el 250 Kcal esta semana'),
                    ...
                    $this->cli(50, '11:32', 'Sí! Y la semana que viene subí al 400 Kcal, quiero el almuerzo y la cena'),
                    $this->ver(50, '11:33', '¡Genial! Tomamos nota para la próxima'),
                    $this->cli(24, '09:00', 'Buen día! Pedido de esta semana, 400 Kcal vegetariano sin lactosa'),
            ...
            [
                ...
                'ordenes' => [
                    ...
                    [
                        ...
                        'forma_pago' => 'transferencia',
                        'items'  => [
                            ['tipo' => 'anti_age', 'tamano' => '400kcal', 'cantidad' => 1],
                            ['tipo' => 'keto',     'tamano' => '400kcal', 'cantidad' => 1],
                        ],
                ...
                'mensajes' => [
                    ...
                    $this->cli(72, '11:03', 'Empiezo con el 250 Kcal para probar'),
                    ...
                    $this->cli(70, '12:00', 'Llegó! Muy bueno, aunque el 250 Kcal me quedó poco para la cena también'),
                    $this->ver(70, '12:01', '¡El 400 Kcal da perfecto para almuerzo y cena! ¿Probamos la semana que viene?'),
                    $this->cli(70, '12:02', 'Sí, hago el cambio. Gracias!'),
                    $this->cli(51, '08:30', 'Buen día! Esta semana quiero el 400 Kcal anti-age'),
                    ...
                    $this->cli(30, '09:00', 'Buen día! El pedido de esta semana: anti-age 400 Kcal y keto 400 Kcal para él'),
            ...
            [
                ...
                'mensajes' => [
                    ...
                    $this->cli(57, '10:03', '400 Kcal, para almuerzo y cena. ¿Cuánto?'),
            ...
            [
                ...
                'ordenes' => [
                    ...
                    [
                        ...
                        'forma_pago' => 'transferencia',
                        'items'  => [
                            ['tipo' => 'intuitivo', 'tamano' => '400kcal', 'cantidad' => 1],
                            ['tipo' => 'anti_age',  'tamano' => '250kcal', 'cantidad' => 1],
                        ],
                        'notas'  => 'Segundo pedido, agrega anti-age 250 Kcal para probar',
                    ],
                ],
                'mensajes' => [
                    ...
                    $this->cli(62, '15:33', 'Suena perfecto! ¿Tiene buen volumen el 400 Kcal?'),
                    ...
                    $this->ver(60, '11:03', '¡Claro! La próxima semana mandamos intuitivo 400 Kcal + anti-age 250 Kcal'),
