# Instructivo operativo de Verdeo

Esta guía describe cómo levantar, comprobar, operar y respaldar el entorno local de Verdeo, conectar una cuenta de WhatsApp mediante Evolution API y verificar la migración incremental de mensajería hacia TypeScript y PostgreSQL.
